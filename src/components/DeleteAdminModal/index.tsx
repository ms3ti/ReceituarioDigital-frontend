...
export function DeleteAdminModal({ id, setSearchWord }: Props) {
    ...
    async function wrapDeletePatient() {
        try {
            ...
            toast.success(<ToastMessage title={`Usuário excluido!`} />);
            onClose();
            setLoading(false);
        } catch (error) {
            setLoading(false);
        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={onClose} isCentered>
                ...
                <ModalContent backgroundColor="white">
                    ...
                    <ModalBody>
                        <Text fontWeight={500}>
                            Ao deletar o usuário, o mesmo não terá mais acesso
                            ao sistema.
                        </Text>
                    </ModalBody>

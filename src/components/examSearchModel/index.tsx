...
import { IPrescriptionCompositionModel } from "../../interfaces/prescriptionModel/prescriptionCompositionModel.dto";
...
interface Props {
    ...
    index: number;
    exam: ICreatePrescriptionCompositionDto | IPrescriptionCompositionModel;
}

export function ExamSearchModel({
    setExamList,
    removeItem,
    index,
    examList,
